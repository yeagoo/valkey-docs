...
- **Vector + semantic cache** — see [For AI developers](/docs/en/for-ai-devs).
...
For most application code, switching Redis to Valkey is a config change. For operations and tooling, read the [versions page](/docs/en/versions) before upgrading across the 7.4 boundary.
